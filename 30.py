...
class CheckersGUI:
    def __init__(self, checkers):
        ...
        # Создаем флажок для опции "Автоматический выбор"
        self.auto_select_var = tk.BooleanVar()
        self.auto_select_checkbox = tk.Checkbutton(self.window, text="Автоматический выбор", variable=self.auto_select_var)
        self.auto_select_checkbox.pack()

        self.window.mainloop()

    def new_game(self):
        # Метод для начала новой игры
        self.checkers.board.create_board()
        self.checkers.current_player = 'white'
        self.draw_pieces()
